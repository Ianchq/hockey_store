...
class ItemsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items.add(Item(1, "sergachev_stick", "MIKHAIL SERGACHEV PRO STOCK - CCM RBZ REVOLUTION", "105 Flex / 168 cm",
        ...
        items.add(Item(2, "malkin_stick", "EVGENI MALKIN - CCM JETSPEED FT3 PRO", "105 Flex / 163 cm",
            "This is a selection of pro stock hockey sticks sourced directly from NHL teams. " +
                    "These sticks were specially designed for these NHL players but were never used by them, " +
                    "which allows us to offer you a brand new top quality stick at an unbeatable price!", 220))

        items.add(Item(3, "mackinnon_stick", "NATHAN MACKINNON - CCM JETSPEED FT5 PRO", "95 Flex / 160 cm",
            "This is a selection of pro stock hockey sticks sourced directly from NHL teams. " +
                    "These sticks were specially designed for these NHL players but were never used by them, " +
